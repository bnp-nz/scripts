...
$MDETargets.Add("https://unitedstates.smartscreen.microsoft.com")
...
$MDETargets.Add("https://unitedstates.smartscreen-prod.microsoft.com")
...
$MDETargets.Add("https://us-v20.events.data.microsoft.com")
